  ...
  return firstValueFrom(
    fnPipe(
      ...
      timeout({
        ...
        with: () =>
          throwError(() => {
            ...
            return new Error('Midnight Lace wallet extension not detected in Chrome.');
          }),
      }),
        ...
        try {
          ...
          try {
            ...
            try {
              ...
              connectedAPI = await initialAPI.connect('Undeclared');
            }
          }
        }
      ...
      catchError((error, apis) => {
        ...
        logger.error('Unable to enable connector API: ' + msg);
        return throwError(() => new Error(msg || 'Application is not authorized'));
      }),
    ),
  );
};
